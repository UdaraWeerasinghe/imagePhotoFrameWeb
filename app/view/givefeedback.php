<?php 
    ...
    $orderObj=new Order();
    $productResult=$orderObj->getproductBy(base64_decode($_REQUEST["orderId"]));
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body style="margin: 0px; padding: 0px;">
        ...
        <div style="padding-top: 80px; margin-bottom: 50px;">
            <div class="container card" style="padding: 50px;">
                <form method="post" action="../controller/product-controller.php?status=giveFeedBack&orderId=<?php echo $_REQUEST["orderId"]; ?>">
                <h3 align="center" style="margin-bottom: 20px;">Give Feedback for your product</h3>
                <?php
                while($pRow=$productResult->fetch_assoc()){
                 ...
                 <div class="row">
                     ...
                     <div class="col-sm-6">
                         <label><?php echo $pRow["pName"] ?></label>
                     </div>
                ...
                <div class="row">
                    <div class="col-3"></div>
                    <div class="col-sm-6">
                        <label style="margin-right: 10px;"><input type="radio" value="1" name="rate" checked>&nbsp;Very Poor</label>
                        <label style="margin-right: 10px;"><input type="radio" value="2" name="rate">&nbsp;Poor</label>
                        <label style="margin-right: 10px;"><input type="radio" value="3" name="rate">&nbsp;Average</label>
                        <label style="margin-right: 10px;"><input type="radio" value="4" name="rate">&nbsp;Good</label>
                        <label style="margin-right: 10px;"><input type="radio" value="5" name="rate">&nbsp;Excellent</label>
                    </div>
                    <div class="col-3"></div> 
                </div><br>
                <div class="row">
                    <div class="col-3"></div>
                    <div class="col-6"><textarea class="form-control" type="text" name="feedBack"></textarea></div>
                    <div class="col-3"></div>
                </div><br>
                <div class="row">
                    <div class="col-3"></div>
                    <div class="col-6"style="text-align: end"><button class="btn btn-warning" type="submit">Give Feedback</button></div>
                    <div class="col-3"></div>
                </div>
                </form>
            </div> 
